...
- 수행 업무 
  - 메인홈 화면, 기업회원 화면, 회원가입 화면, 채용공고 화면, 공고등록 화면, 검색 화면 등 다양한 안드로이드 화면 구성 및 기능 구현
  - 워크넷 Open API 연동을 통해 워크넷 채용공고 리스트 불러오기 및 워크넷 채용공고 검색, 채용공고 상세 페이지 기능, 조건검색 시 직종 대/중 분류 기능, 기업회원 로그인 기능 등 구현
  - 서버에서 채용공고 리스트 불러오기 및 채용공고 등록/삭제/수정/재등록 기능 구현 등
